...
public class ChiTien {
    ...
    public ChiTien(long tien, String hangMuc, String dienGiai, String ngay, String gio, String chuyenDi, String chiChoAi, String diaDiem, byte[] anh, String thang, String nam, int id) {
        this.tien = tien;
    ...
    public ChiTien(long tien, String hangMuc, String dienGiai, String ngay, String gio, String chuyenDi, String chiChoAi, String diaDiem, byte[] anh, String thang, String nam) {
        this.tien = tien;
        this.hangMuc = hangMuc;
        this.dienGiai = dienGiai;
        this.ngay = ngay;

...
public class ThuTien {
    ...
    public ThuTien(long tien, String hangMuc, String dienGiai, String ngay, String gio, String chuyenDi, String thuTuAi, String diaDiem, String thang, String nam, byte[] anh, int id) {
        this.tien = tien;
    ...
    public ThuTien(long tien, String hangMuc, String dienGiai, String ngay, String gio, String chuyenDi, String thuTuAi, String diaDiem, String thang, String nam, byte[] anh) {
        this.tien = tien;
        this.hangMuc = hangMuc;
        this.dienGiai = dienGiai;
        this.ngay = ngay;
